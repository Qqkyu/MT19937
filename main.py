...
if __name__ == "__main__":
    ...
    generateFileWithRandomNums(gen, 200000000)
    #unif = uniform_distribution.UniformDistribution(1000, 2000)
    #unif_plot = plot_unif_dist.UnifDistPlot(unif)
    #unif_plot.plot()
    #bern = bernoulli_distribution.BernoulliDistribution(0.1)
    #bern_plot = plot_bern_dist.BernDistPlot(bern, 100000)
    #bern_plot.plot()
    #binom = binomial_distribution.BinomialDistribution(0.75, 100)
    ...
    #poiss_plot.plot()
    #exp = exponential_distribution.ExponentialDistribution(1.5)
    #exp_plot = plot_exp_dist.ExpDistPlot(exp, 10000)
    #exp_plot.plot()
    #norm = normal_distribution.NormalDistribution(-2, 2)
